...
public class bow extends EquippableItem {
    ...
    public bow(equippableItemDecoration decoration) {
        ...
        ID = Item.ItemDictionary.getDictionaryItemFromID(1706 + decoration.IDModifier);
        name = "{NAME} Bow".replace("{NAME}", decoration.nameModifier);
        description = "A bow body made of {NAME}".replace("{NAME}", decoration.descriptionModifier);
