...
public class PetController extends NPCController implements Observer {
    ...
    private void createMovementTasks() {
        ...
        moveNorthWest = new Task() {
            @Override
            public void run() {
                pet.move(Map.Direction.NORTH_WEST);
            }
        ...
        moveSouthWest = new Task() {
            @Override
            public void run() {
                pet.move(Map.Direction.SOUTH_WEST);
            }
        ...
        moveSouthEast = new Task() {
            @Override
            public void run() {
                pet.move(Map.Direction.SOUTH_EAST);
            }
        ...
        moveNorthEast = new Task() {
            @Override
            public void run() {
                pet.move(Map.Direction.NORTH_EAST);
            }
